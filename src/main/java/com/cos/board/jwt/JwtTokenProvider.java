...
import com.cos.board.service.CustomUserDetailsService;
...
public class JwtTokenProvider {
	...
	public Token createToken(String username) {
		...
		String token =Jwts.builder()
				...
				.compact();
		setedToken.setExpiredTime(tokenValidMillisecond);
		setedToken.setToken_key(token);
	...
	public Authentication getAuthentication(String token) {
		...
		LOGGER.info("[     getAuthentication] 토큰 인증 정보 조회 완료, UserDetails UserName : {} ",user.getUsername());
